...
import workshop.db.repository.BottomBracketRepository;
import workshop.db.repository.BrakeRepository;
import workshop.db.repository.CassetteRepository;
import workshop.db.repository.ChainRepository;
import workshop.db.repository.ChainringRepository;
import workshop.db.repository.CrankRepository;
import workshop.db.repository.DiscRepository;
import workshop.db.repository.ForkRepository;
import workshop.db.repository.FrameRepository;
import workshop.db.repository.FrontDerailleurRepository;
import workshop.db.repository.GripsRepository;
import workshop.db.repository.HandlebarRepository;
import workshop.db.repository.HeadSetRepository;
import workshop.db.repository.HubRepository;
import workshop.db.repository.PedalsRepository;
import workshop.db.repository.RearDerailleurRepository;
import workshop.db.repository.RimRepository;
import workshop.db.repository.SaddleRepository;
import workshop.db.repository.SeatpostClampRepository;
import workshop.db.repository.SeatpostRepository;
import workshop.db.repository.ShifterLeftRepository;
import workshop.db.repository.ShifterRightRepository;
import workshop.db.repository.StemRepository;
import workshop.db.repository.TyreRepository;
